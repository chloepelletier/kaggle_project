...
weather_dwd.drop('radiation', axis=1, inplace=True)
...
weather_osnabrueck.drop('global_solar_radiation_UniOS', axis=1, inplace=True)
weather_osnabrueck.drop('wind_direction_category_UniOS', axis=1, inplace=True)
weather_osnabrueck.drop('wind_speed_avg_UniOS', axis=1, inplace=True)
...
weather_dwd.drop('precipitation', axis=1, inplace=True)
...
result = pd.merge(result, weather_dwd_2, on='date', how='outer')
